    ...
    MiuixTheme(
        ...
        content = {
            val transparentColors = MiuixTheme.colorScheme.copy(
                surface = MiuixTheme.colorScheme.surface.copy(alpha = 0.35f),
                surfaceContainer = MiuixTheme.colorScheme.surface.copy(alpha = 0.35f),
                surfaceContainerHigh = MiuixTheme.colorScheme.surface.copy(alpha = 0.35f),
                surfaceContainerHighest = MiuixTheme.colorScheme.surface.copy(alpha = 0.35f)
            )

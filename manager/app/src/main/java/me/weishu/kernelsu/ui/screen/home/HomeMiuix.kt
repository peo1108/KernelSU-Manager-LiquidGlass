...
fun HomePagerMiuix(
    ...
    val hazeStyle = if (enableBlur) {
        HazeStyle(
            ...
            tint = HazeTint(colorScheme.surface.copy(0.03f)),
            blurRadius = 3.dp
        )
    } else {
                ...
                Row(
                    ...
                    Column(
                        ...
                        Card(
                            ...
                            showIndication = true,
                            colors = CardDefaults.defaultColors(color = colorScheme.surface.copy(alpha = 0.05f)),
                            pressFeedbackType = PressFeedbackType.Tilt
                        ) {
...
private fun LearnMoreCard(
    ...
    Card(modifier = Modifier.fillMaxWidth(), colors = CardDefaults.defaultColors(color = colorScheme.surface.copy(alpha = 0.05f))) {
        BasicComponent(
...
private fun InfoCard(systemInfo: SystemInfo) {
    ...
    Card(colors = CardDefaults.defaultColors(color = colorScheme.surface.copy(alpha = 0.05f))) {
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .padding(16.dp)
